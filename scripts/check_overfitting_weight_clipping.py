...
def run_training_with_clipping(features, labels, config, model_class, experiment_name, genre_names):
...
def main():
    ...
    config = {
        ...
        'experiment_name': 'check_overfitting_weight_clipping',
        'weight_decay': 0.0
    }
    
    experiment_name = config['experiment_name']
    fold_results = run_training_with_clipping(features, labels, config, WeightClippingModel, experiment_name, genre_names)
