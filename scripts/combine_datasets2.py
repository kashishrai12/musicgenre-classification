...
if __name__ == "__main__":
    ...
    print("\n=== Final Evaluation ===")
    gtzan_acc = evaluate_model(fold_results[0], data['X_gtzan_test'], data['y_gtzan_test'], 
                             data['label_encoder'], "GTZAN")
    fma_acc = evaluate_model(fold_results[0], data['X_fma_test'], data['y_fma_test'], 
                           data['label_encoder'], "FMA")
