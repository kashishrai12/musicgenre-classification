...
class DropoutClassifier4_4(nn.Module):
...
def main():
    ...
    config = {
        ...
        'experiment_name': 'exp4_4_dropout'
    }
    
    experiment_name = config['experiment_name']
    fold_results = run_training(features, labels, config, DropoutClassifier4_4, experiment_name)
