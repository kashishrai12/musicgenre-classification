...
def main():
    ...
    # Step 2: Analyze Clusters (K=2)
    print("\nAnalyzing Cluster Distributions for K=2...")
    kmeans_2 = cluster_results[2]['clusters']
    df_hierarchy = pd.DataFrame({'Genre': y_train, 'Group': kmeans_2})
    ...
    group_test_result = evaluate_model(group_classifier, X_test, group_labels_test, ['Group 0', 'Group 1'])
    ...
    with open(r"D:\research_project\results\hierarchical_classification_results.csv", 'w', newline='') as csvfile:
