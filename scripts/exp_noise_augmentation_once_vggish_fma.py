...
def main():
    ...
    # Load training data
    train_data_path = r"D:\research_project\preprocessed_vggish_fma\extracted_train_fma_vggish.npz"
    train_data = np.load(train_data_path)
    train_features = train_data['features']
    train_labels = train_data['labels']
    
    # Load test data
    test_data_path = r"D:\research_project\preprocessed_vggish_fma\extracted_test_fma_vggish.npz"
    ...
    # Save results to CSV
    results = {
        'experiment_name': 'exp_noise_augmentation_once_vggish_fma',
